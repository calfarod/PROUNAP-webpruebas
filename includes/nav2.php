    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse justify-content-center" id="mainNav">
            <ul class="navbar-nav mb-2 mb-lg-0 mx-auto">
                ...
                <li class="nav-item <?php if ($pagina_actual == 'index.php')
                    echo 'active'; ?>">
                ...
                <li class="nav-item <?php if ($pagina_actual == 'testfile1.php')
                    echo 'active'; ?>">
                ...
                <li class="nav-item <?php if ($pagina_actual == 'red-profesional.php')
                    echo 'active'; ?>">
                ...
                <li
                    class="nav-item dropdown <?php echo in_array($pagina_actual, $paginas_reflexiones) ? 'active' : ''; ?>">
                    <a class="nav-link dropdown-toggle" href="reflexiones.php" target="_self"
                        id="navbarDropdownReflexiones" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        Reflexiones
                    </a>
                ...
                <li class="nav-item <?php if ($pagina_actual == 'unete.php')
                    echo 'active'; ?>">
                    <a class="nav-link" href="unete.php" target="_self">
                        Únete
                    </a>
                </li>
                <li class="nav-item <?php if ($pagina_actual == 'contacto.php')
                    echo 'active'; ?>">
