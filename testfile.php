...
<body class="bg-light">
    ...
    <!-- Sección 1 - Qs-->
    <section id="mision" class="section-featured bg-white py-5"
        style="background: url('img/pimg16.jpg') center center / cover no-repeat;">
        <div class="container py-5">
            <h2 class="display-4 fw-bold text-center mb-5 text-white">Test File - Misión - Envío 1 - <?php echo $pagina_actual; ?></h2>
            <div class="row align-items-center">
                <!-- Contenedor Izquierda: Imagen -->
                <div class="col-md-6 d-flex justify-content-center">
                    <img src="img/pimg24.jpg" alt="Imagen destacada" class="img-fluid rounded-4"
        ...
        <!-- Sección 2 - Qs-->
    <section id="vision" class="section-featured bg-white py-5"
        style="background: url('img/pimg16.jpg') center center / cover no-repeat;">
        <div class="container py-5">
            <h2 class="display-4 fw-bold text-center mb-5 text-white">Test File - Visión</h2>
            <div class="row align-items-center">
                <!-- Contenedor Izquierda: Imagen -->
                <div class="col-md-6 d-flex justify-content-center">
                    <img src="img/pimg20.png" alt="Imagen destacada" class="img-fluid rounded-4"
                        style="height:660px; object-fit:cover; max-width:100%;">
                </div>
                <!-- Contenedor Derecha: Texto, bullets y botón -->
                <div class="col-md-6 d-flex flex-column justify-content-center px-md-5 mt-4 mt-md-0">
        ...
        <!-- Sección 3 - Qs-->
    <section id="historia" class="section-featured bg-white py-5"
        style="background: url('img/pimg16.jpg') center center / cover no-repeat;">
        <div class="container py-5">
            <h2 class="display-4 fw-bold text-center mb-5 text-white">Test File - Historia</h2>
            <div class="row align-items-center">
                <!-- Contenedor Izquierda: Imagen -->
                <div class="col-md-6 d-flex justify-content-center">
                    <img src="img/pimg19.png" alt="Imagen destacada" class="img-fluid rounded-4"
                        style="height:660px; object-fit:cover; max-width:100%;">
                </div>
                <!-- Contenedor Derecha: Texto, bullets y botón -->
                <div class="col-md-6 d-flex flex-column justify-content-center px-md-5 mt-4 mt-md-0">
