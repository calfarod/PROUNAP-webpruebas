        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse justify-content-center" id="mainNav">
                <ul class="navbar-nav mb-2 mb-lg-0 mx-auto">
                    ...
                    <li class="nav-item"><a class="nav-link" href="quienes-somos.html" target="_self">Quiénes
                            Somos</a></li>
                ...
                <div class="d-flex ms-lg-3">
                    <?php if ($is_logged_in): ?>
                        <a href="dashboard.php" target="_self" class="btn btn-outline-primary me-2">Mi Perfil (<?= htmlspecialchars($username) ?>)</a>
                        <a href="logout.php" target="_self" class="btn btn-outline-primary me-2">Cerrar Sesión</a>
                    <?php else: ?>
                        <a href="login.php" target="_self" class="btn btn-outline-primary me-2">Login</a>
                        <a href="register.php" target="_self" class="btn btn-outline-primary me-2">Registro</a>
                    <?php endif; ?>
                </div>
